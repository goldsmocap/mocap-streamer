...
*/
  ...
  CDLL_EXPORT CEnum Client_EnableCameraCalibrationData( CClient* client );
  ...
  CDLL_EXPORT CEnum Client_DisableCameraCalibrationData( CClient* client );
  ...
  CDLL_EXPORT CBool Client_IsCameraCalibrationDataEnabled( CClient* client );
  ...
  CDLL_EXPORT void Client_GetDynamicCameraCount( CClient* client, COutput_GetCameraCount* outptr );
  CDLL_EXPORT CEnum Client_GetCameraName( CClient* client, unsigned int i_CameraIndex, int sizeOfBuffer, char* outstr );
  CDLL_EXPORT CEnum Client_GetDynamicCameraName( CClient* client, unsigned int i_CameraIndex, int sizeOfBuffer, char* outstr );
  ...
  CDLL_EXPORT void Client_GetCameraGlobalTranslation( CClient* client, CString i_rCameraName, COutput_GetCameraGlobalTranslation* outptr );
  CDLL_EXPORT void Client_GetCameraGlobalRotationHelical( CClient* client, CString i_rCameraName, COutput_GetCameraGlobalRotationHelical* outptr );
  CDLL_EXPORT void Client_GetCameraGlobalRotationMatrix( CClient* client, CString i_rCameraName, COutput_GetCameraGlobalRotationMatrix* outptr );
  CDLL_EXPORT void Client_GetCameraGlobalRotationQuaternion( CClient* client, CString i_rCameraName, COutput_GetCameraGlobalRotationQuaternion* outptr );
  CDLL_EXPORT void Client_GetCameraGlobalRotationEulerXYZ( CClient* client, CString i_rCameraName, COutput_GetCameraGlobalRotationEulerXYZ* outptr );
  CDLL_EXPORT void Client_GetCameraFocalLength( CClient* client, CString i_rCameraName, COutput_GetCameraFocalLength* outptr );
  CDLL_EXPORT void Client_GetCameraPrincipalPoint( CClient* client, CString i_rCameraName, COutput_GetCameraPrincipalPoint* outptr );
  CDLL_EXPORT void Client_GetCameraLensParameters( CClient* client, CString i_rCameraName, COutput_GetCameraLensParameters* outptr );
  ...
  CDLL_EXPORT CEnum Client_SetConnectionTimeout(CClient* client, unsigned int i_Timeout );
